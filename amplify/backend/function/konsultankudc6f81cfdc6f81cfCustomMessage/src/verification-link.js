...
exports.handler = async (event) => {
  ...
  if (event.triggerSource === "CustomMessage_SignUp") {
    ...
    const url = `https://www.test.seajobs.co/user/verifyuser?data=${payload}&code=${codeParameter}`; //`${bucketUrl}/?data=${payload}&code=${codeParameter}`;
    ...
    const htmlstring = `<!DOCTYPE html>
		...
		<body style="background-color: #e9ecef;">
			...
			<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
				Verify your account at test.seajobs.co
			</div>
			<!-- end preheader -->
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							<tr>
								<td align="center" valign="top" style="padding: 36px 24px;">
									<a href="https://www.test.seajobs.co" target="_blank" style="display: inline-block;">
										<img src="https://public-seajobs-bucket.s3.ap-southeast-3.amazonaws.com/logo_1.png" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
									</a>
								</td>
							</tr>
						</table>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							...
							<tr>
								<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
									<p style="margin: 0;">Tap the button below to confirm your email address. If you didn't create an account with <a href="https://test.seajobs.co">Test Seajobs</a>, you can safely delete this email.</p>
								</td>
							</tr>
							<!-- end copy -->
							...
							<!-- start copy -->
							<tr>
								<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; max-width: 600px; ">
									<p style="margin: 0;">If that doesn't work, copy and paste the following link in your browser:</p>
									<p style="margin: 0; overflow-wrap: break-word;"><a href=${url} target="_blank">${url}</a></p>
								</td>
							</tr>
							<!-- end copy -->
							...
							<tr>
								<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
									<p style="margin: 0;">Cheers,<br> Test Seajobs</p>
								</td>
							</tr>
							<!-- end copy -->
				...
				<tr>
					<td align="center" bgcolor="#e9ecef" style="padding: 24px;">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
							...
							<tr>
								<td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
									<p style="margin: 0;">Tim Seajobs Testing, Jakarta</p>
								</td>
							</tr>
							<!-- end unsubscribe -->
    ...
    event.response.emailMessage = htmlstring;
